    ...
    return (
        <main>
            ...
            <p>Hello stranger, welcome to my humble abode on the internet.
                My name is Adithya. I'm one of those people you'll rarely find on mainstream social media, so anything I
                want to put out there will be on this website.
                <br/>
                <br/>
                I'm a huge fan of and advocate for everything Open Source and Privacy respecting. I love poking around
                ...
                In my professional life, I'm a Consultant at <a href={"https://thoughtworks.com"} target={"_blank"}
                                                                rel={"noreferrer"}>ThoughtWorks, Inc.</a> where I work
